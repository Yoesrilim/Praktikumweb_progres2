...
<body>
    ...
    <div class="container-fluid">
      ...
      <!-- Page Heading -->
      <i class="fa fa-bed"></i> Best Hotel </div>
      <hr class="mt-2">

      <div class="row">
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="img/hotelbromo.jpg" height="220"></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">Hotel Bromo</a>
              </h4>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="img/hotellabuanbajo.jpg" height="220"></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">Hotel Labuan Bajo</a>
              </h4>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="img/hotelrajaampat.jpg" height="220"></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">Hotel Raja Ampat</a>
              </h4>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="img/hotel.jpg" height="220"></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#">Hotel Nusa Penida</a>
              </h4>
            </div>
          </div>
        </div>
